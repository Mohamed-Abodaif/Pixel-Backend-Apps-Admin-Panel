...
class CreateComapntTransOutflowsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('comapnt_trans_outflows', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('comapnt_trans_outflows');
    }
}
