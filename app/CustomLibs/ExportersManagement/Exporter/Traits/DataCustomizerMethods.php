...
trait DataCustomizerMethods
{
    ...
    protected int $normalServerProcessingMaxRowCountLimit = 2;
    ...
    {
        $this->dataRowsCount = $count > 0 ? $count : $this->builder->count();
        if($this->dataRowsCount == 0 ) { throw $this->getEmptyDataException();}
        return $this;
    }

    protected function LazyDataById() : void
    {
        $this->DataCollection = $this->builder->lazyById($this->normalServerProcessingMaxRowCountLimit , $this->modelPrimaryKeyName);
    }
    ...
    protected function setDataCollection(?Collection $collection = null) : self
    {
        ...
        if($this->dataRowsCount > $this->normalServerProcessingMaxRowCountLimit)
        {
            $this->LazyDataById();
            return $this;
        }
    ...
    protected function DoesItNeedToBackgroundProcessing() : bool
    {
        return $this->dataRowsCount > $this->normalServerProcessingMaxRowCountLimit;
    }
