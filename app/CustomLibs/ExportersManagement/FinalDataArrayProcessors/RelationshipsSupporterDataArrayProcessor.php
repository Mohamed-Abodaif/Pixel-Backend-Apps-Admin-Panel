...
namespace App\CustomLibs\ExportersManagement\FinalDataArrayProcessors;

use App\CustomLibs\ExportersManagement\FinalDataArrayProcessors\Traits\RelationshipsDesiredColumnsValidators;
...
abstract class RelationshipsSupporterDataArrayProcessor extends DataArrayProcessor implements HasRelationshipsDesiredColumns
{
    ...
    {
        $row = parent::processDataRow($model);
        return $this->processModelRelationshipsDesiredColumns($model , $row);
    }
}
