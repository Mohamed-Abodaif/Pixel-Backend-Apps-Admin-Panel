...
namespace App\CustomLibs\ExportersManagement\FinalDataArrayProcessors\PresentationDataArrayProcessors;

use App\CustomLibs\ExportersManagement\ExporterStringValueProcessor\ExporterStringValueProcessor;
use App\CustomLibs\ExportersManagement\FinalDataArrayProcessors\RelationshipsSupporterDataArrayProcessor;
...
class PresentationDataArrayProcessor extends RelationshipsSupporterDataArrayProcessor
{
    ...
    protected function processModelSingleRelationshipDesiredColumnsInternalFun( string $relationship , null | array $relationshipDetailsArray  ,?Model $model = null   , array $dataRowArray = []) : array
    {
        foreach ($relationshipDetailsArray["columns"] as $index => $value)
        {
             ...
             */
            $dataRowArray = $this->processModelRelationshipsSingleDesiredColumn(  $relationship , $value , $model  , $dataRowArray , $relationshipDetailsArray["columns_prefix"]);
        }
        return $dataRowArray;
    }
