...
use App\Http\Requests\WorkSector\SystemConfigurations\ProductCategory\StoringProductCategoryRequest;
...
class ProductCategoryStoringService extends SystemConfigurationStoringService implements MustCreatedMultiplexed, NeedToStoreDateFields
{

    protected function getDefinitionCreatingFailingErrorMessage(): string
    {
        return "Failed To Create The Given Product Category!";
    }

    protected function getDefinitionCreatingSuccessMessage(): string
    {
        return "The ProductCategory Has Been Created Successfully!";
    }
    ...
    {
        return StoringProductCategoryRequest::class;
    }
