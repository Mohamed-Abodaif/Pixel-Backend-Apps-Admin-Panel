...
namespace App\Http\Requests\WorkSector\SystemConfigurationsRequests\TimesheetSubCategories;
    ...
    public function rules()
    {
        return array_merge(
            ...
            [
                ...
                "timesheet_category_id" => ["exists:employees_timesheet_categories,id"]
            ]
        );
    }
