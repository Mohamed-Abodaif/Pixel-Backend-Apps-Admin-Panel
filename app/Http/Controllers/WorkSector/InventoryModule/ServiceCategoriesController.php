...
use App\Models\WorkSector\InventoryModule\ServiceCategory;
use App\Http\Requests\WorkSector\InventoryModule\ServiceCategoryRequest;
...
class ServiceCategoriesController extends Controller
{
    ...
    public function update(ServiceCategoryRequest $request, $id)
    {
        ...
        $asset_category = ServiceCategory::findOrFail($id);
